...
(() => {
  ...
  // node_modules/@storybook/addon-docs/dist/_browser-chunks/chunk-SPXYZZB5.js
  function _extends() {
  ...
  var ERRORS, PolishedError, cssRegex$1, pxtoFactory, pixelsto, em, rem, namedColorMap, hexRegex, hexRgbaRegex, reducedHexRegex, reducedRgbaHexRegex, rgbRegex, rgbaRegex, hslRegex, hslaRegex, reduceHexValue, reduceHexValue$1, isRgb, isRgba, isHsl, isHsla, curriedAdjustHue, curriedDarken, curriedDesaturate, curriedLighten, curriedMix, mix$1, curriedOpacify, curriedSaturate, curriedSetHue, curriedSetLightness, curriedSetSaturation, curriedShade, curriedTint, curriedTransparentize, curriedTransparentize$1, Wrapper, EmptyBlock, StyledSyntaxHighlighter, SourceSkeletonWrapper, SourceSkeletonPlaceholder, SourceSkeleton, Source, init_chunk_SPXYZZB5 = __esm({
    "node_modules/@storybook/addon-docs/dist/_browser-chunks/chunk-SPXYZZB5.js"() {
      init_define_module();
      init_define_process_env();
      init_define_process_env_NODE_PATH();
...
`
      ...
      curriedDarken = curry(darken2);
      curriedDesaturate = curry(desaturate);
      curriedLighten = curry(lighten2);
      ...
      curriedTransparentize = curry(transparentize), curriedTransparentize$1 = curriedTransparentize, Wrapper = styled.div(withReset, ({ theme }) => ({
      ...
      })), EmptyBlock = (props) => react_default.createElement(Wrapper, { ...props, className: "docblock-emptyblock sb-unstyled" }), StyledSyntaxHighlighter = styled(
        SyntaxHighlighter
      )(({ theme }) => ({
      ...
      })), SourceSkeleton = () => react_default.createElement(SourceSkeletonWrapper, null, react_default.createElement(SourceSkeletonPlaceholder, null), react_default.createElement(SourceSkeletonPlaceholder, { style: { width: "80%" } }), react_default.createElement(SourceSkeletonPlaceholder, { style: { width: "30%" } }), react_default.createElement(SourceSkeletonPlaceholder, { style: { width: "80%" } })), Source = ({
        isLoading,
        error,
        language,
        code,
        ...
        return react_default.createElement(
          ThemeProvider,
          {
            theme: convert({
              ...overrideTheme,
              fontCode: typography2.fonts.mono,
              fontBase: typography2.fonts.base
            })
          },
          syntaxHighlighter
        );
  ...
  // node_modules/@storybook/addon-docs/dist/_browser-chunks/chunk-SL3VIQZ3.js
  var init_chunk_SL3VIQZ3 = __esm({
    "node_modules/@storybook/addon-docs/dist/_browser-chunks/chunk-SL3VIQZ3.js"() {
      init_define_module();
      init_define_process_env();
      init_define_process_env_NODE_PATH();
  ...
  var ADDON_ID, PANEL_ID, PARAM_KEY, SNIPPET_RENDERED, CodePanel, SourceStyles, init_manager = __esm({
    "node_modules/@storybook/addon-docs/dist/manager.js"() {
      init_define_module();
      init_define_process_env();
      init_define_process_env_NODE_PATH();
      ...
      init_manager_api();
      init_theming();
      ADDON_ID = "storybook/docs", PANEL_ID = `${ADDON_ID}/panel`, PARAM_KEY = "docs", SNIPPET_RENDERED = `${ADDON_ID}/snippet-rendered`, CodePanel = ({
        active,
        lastEvent,
        currentStoryId
      }) => {
        ...
        useEffect(() => {
          ...
          [SNIPPET_RENDERED]: ({ source, format: format2 }) => {
            setSourceCode({ source, format: format2 });
          }
        });
        let isDark = useTheme().base !== "light";
        return react_default.createElement(AddonPanel, { active: !!active }, react_default.createElement(SourceStyles, null, react_default.createElement(
          Source,
          {
            ...parameter.source,
      ...
      addons.register(ADDON_ID, (api) => {
        addons.add(PANEL_ID, {
          ...
          render: ({ active }) => {
            ...
            return react_default.createElement(CodePanel, { currentStoryId: currentStory?.id, lastEvent, active });
          }
        });
      });
      SourceStyles = styled.div(() => ({
        height: "100%",
        [`> :first-child${ignoreSsrWarning}`]: {
          margin: 0,
          height: "100%",
  ...
  // node_modules/.cache/storybook/10.3.5/1c3385a5d25e538d10b518b310c74d3ca2690b6aaffeadccd74da79736171f86/sb-manager/docs-2/manager-bundle.js
