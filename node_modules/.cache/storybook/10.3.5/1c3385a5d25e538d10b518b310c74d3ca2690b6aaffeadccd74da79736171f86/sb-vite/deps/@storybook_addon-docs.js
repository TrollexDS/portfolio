import { n as __export } from "./chunk-SL3VIQZ3-SSoU9wa9.js";
import { At as definePreviewAddon10 } from "./components-Cq1AAyAn.js";
import { t as DocsRenderer } from "./chunk-OATZR77O-CEfT6Use.js";
//#region node_modules/@storybook/addon-docs/dist/_browser-chunks/chunk-S4QKU6I5.js
var preview_exports = {};
...
var excludeTags = Object.entries(globalThis.TAGS_OPTIONS ?? {}).reduce((acc, entry) => {
	...
	renderer: async () => {
		let { DocsRenderer } = await import("./DocsRenderer-LL677BLK-CA4wvc1m.js");
		return new DocsRenderer();
	},
	stories: { filter: (story) => (story.tags || []).filter((tag) => excludeTags[tag]).length === 0 && !story.parameters.docs?.disable }
} };
//#endregion
//#region node_modules/@storybook/addon-docs/dist/index.js
