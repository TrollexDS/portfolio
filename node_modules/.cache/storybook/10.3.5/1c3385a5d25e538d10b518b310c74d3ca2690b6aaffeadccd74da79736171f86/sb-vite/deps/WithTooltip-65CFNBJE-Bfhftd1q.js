...
import { t as require_react_dom } from "./react-dom-D-efzOyR.js";
import { C as require_client_logger, O as _extends, S as require_global, f as styled, v as lightenColor } from "./theming-BkRpnJXm.js";
...
var require_warning = __commonJS({ "../../node_modules/warning/warning.js"(exports, module) {
	"use strict";
...
}, useIsomorphicLayoutEffect = typeof window < "u" && window.document && window.document.createElement ? import_react.useLayoutEffect : import_react.useEffect;
...
var createPopper3 = popperGenerator({ defaultModifiers: [
	eventListeners_default,
	popperOffsets_default,
	computeStyles_default,
	applyStyles_default,
...
var EMPTY_MODIFIERS = [], usePopper = function(referenceElement, popperElement, options) {
	options === void 0 && (options = {});
	var prevOptions = import_react.useRef(null), optionsWithDefaults = {
		onFirstUpdate: options.onFirstUpdate,
		placement: options.placement || "bottom",
		strategy: options.strategy || "absolute",
		modifiers: options.modifiers || EMPTY_MODIFIERS
	}, _React$useState = import_react.useState({
		styles: {
			popper: {
		...
		attributes: {}
	}), state = _React$useState[0], setState = _React$useState[1], updateStateModifier = import_react.useMemo(function() {
		return {
			name: "updateState",
			enabled: !0,
			phase: "write",
	...
	}, []), popperOptions = import_react.useMemo(function() {
		var newOptions = {
		...
		updateStateModifier
	]), popperInstanceRef = import_react.useRef();
...
function useGetLatest(val) {
	var ref = import_react.useRef(val);
	return ref.current = val, import_react.useCallback(function() {
		return ref.current;
	}, []);
}
var noop = function() {};
function useControlledState(_ref) {
	...
	var _React$useState = import_react.useState(initial), state = _React$useState[0], setState = _React$useState[1], getLatest = useGetLatest(state), set = import_react.useCallback(function(updater) {
...
var _excluded = ["styles", "attributes"], virtualElement = { getBoundingClientRect: generateBoundingClientRect() }, defaultConfig = {
...
function usePopperTooltip(config, popperOptions) {
	...
	}, config), defaultModifiers3 = import_react.useMemo(function() {
		return [{
			name: "offset",
	...
	}), _React$useState = import_react.useState(null), triggerRef = _React$useState[0], setTriggerRef = _React$useState[1], _React$useState2 = import_react.useState(null), tooltipRef = _React$useState2[0], setTooltipRef = _React$useState2[1], _useControlledState = useControlledState({
		initial: finalConfig.defaultVisible,
		value: finalConfig.visible,
		onChange: finalConfig.onVisibleChange
	}), visible = _useControlledState[0], setVisible = _useControlledState[1], timer = import_react.useRef();
	...
	var _usePopper = usePopper(finalConfig.followCursor ? virtualElement : triggerRef, tooltipRef, finalPopperOptions), styles = _usePopper.styles, attributes = _usePopper.attributes, popperProps = _objectWithoutPropertiesLoose(_usePopper, _excluded), update = popperProps.update, getLatest = useGetLatest({
		...
		tooltipRef,
		finalConfig
	}), isTriggeredBy = import_react.useCallback(function(trigger) {
		return Array.isArray(finalConfig.trigger) ? finalConfig.trigger.includes(trigger) : finalConfig.trigger === trigger;
	}, Array.isArray(finalConfig.trigger) ? finalConfig.trigger : [finalConfig.trigger]), hideTooltip = import_react.useCallback(function() {
		clearTimeout(timer.current), timer.current = window.setTimeout(function() {
			return setVisible(!1);
		}, finalConfig.delayHide);
	}, [finalConfig.delayHide, setVisible]), showTooltip = import_react.useCallback(function() {
		clearTimeout(timer.current), timer.current = window.setTimeout(function() {
			return setVisible(!0);
		}, finalConfig.delayShow);
	}, [finalConfig.delayShow, setVisible]), toggleTooltip = import_react.useCallback(function() {
	...
	}, [getLatest, hideTooltip]), import_react.useEffect(function() {
...
var { document: document2 } = import_global.global, match = (0, import_memoizerific.default)(1e3)((requests, actual, value, fallback = 0) => actual.split("-")[0] === requests ? value : fallback), ArrowSpacing = 8, Arrow = styled.div({
	position: "absolute",
	borderStyle: "solid"
}, ({ placement }) => {
	let x = 0, y = 0;
...
}, DeprecatedPure = (props) => ((0, import_client_logger.deprecate)("WithTooltipPure is deprecated and will be removed in Storybook 11. Please use WithTooltip instead."), import_react.createElement(WithTooltipPure, {
...
//# sourceMappingURL=WithTooltip-65CFNBJE-Bfhftd1q.js.map