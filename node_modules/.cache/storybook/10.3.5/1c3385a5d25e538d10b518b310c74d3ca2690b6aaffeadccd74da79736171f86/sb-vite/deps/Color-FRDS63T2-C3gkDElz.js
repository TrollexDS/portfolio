...
import { i as getControlId, r as __toESM$1, t as __commonJS } from "./chunk-SL3VIQZ3-SSoU9wa9.js";
import { f as styled } from "./theming-BkRpnJXm.js";
import { Kt as MarkupIcon, c as Button, y as Form, z as PopoverProvider } from "./components-Cq1AAyAn.js";
//#region node_modules/@storybook/addon-docs/dist/_browser-chunks/Color-FRDS63T2.js
...
var import_color_convert = __toESM$1(__commonJS({ "../../../node_modules/color-convert/index.js"(exports, module) {
...
var s = function(e2, r2, t2) {
...
}, m = import_react.memo(function(o2) {
	var a2 = o2.onMove, l2 = o2.onKey, s2 = c(o2, ["onMove", "onKey"]), m2 = (0, import_react.useRef)(null), g2 = i(a2), p2 = i(l2), b2 = (0, import_react.useRef)(null), _2 = (0, import_react.useRef)(!1), x2 = (0, import_react.useMemo)(function() {
		var e2 = function(e3) {
	...
	return (0, import_react.useEffect)(function() {
		return H2;
	}, [H2]), import_react.createElement("div", u({}, s2, {
		onTouchStart: C2,
		onMouseDown: C2,
...
var S = import_react.memo(function(r2) {
	var t2 = r2.hue, n2 = r2.onChange, o2 = g(["react-colorful__hue", r2.className]);
	return import_react.createElement("div", { className: o2 }, import_react.createElement(m, {
		onMove: function(e2) {
			n2({ h: 360 * e2.left });
		},
		onKey: function(e2) {
...
}), T = import_react.memo(function(r2) {
...
function Y(e2, t2, l2) {
	var u2 = i(l2), c2 = (0, import_react.useState)(function() {
		return e2.toHsva(t2);
	}), s2 = c2[0], f2 = c2[1], v2 = (0, import_react.useRef)({
		color: t2,
		hsva: s2
	});
	...
	return [s2, (0, import_react.useCallback)(function(e3) {
		f2(function(r2) {
			return Object.assign({}, r2, e3);
		});
	}, [])];
}
var R, V = typeof window < "u" ? import_react.useLayoutEffect : import_react.useEffect, $ = function() {
...
var J = /* @__PURE__ */ new Map(), Q = function(e2) {
	...
	var n2 = t2.className, o2 = t2.colorModel, a2 = t2.color, l2 = a2 === void 0 ? o2.defaultColor : a2, i2 = t2.onChange, s2 = c(t2, [
		...
		"color",
		"onChange"
	]), f2 = (0, import_react.useRef)(null);
	Q(f2);
	var v2 = Y(o2, l2, i2), d2 = v2[0], h2 = v2[1], m2 = g(["react-colorful", n2]);
	return import_react.createElement("div", u({}, s2, {
		ref: f2,
		className: m2
	...
	return import_react.createElement(U, u({}, r2, { colorModel: W }));
}, ee = function(r2) {
	...
	return import_react.createElement("div", { className: l2 }, import_react.createElement("div", {
...
var le = {
	...
	return import_react.createElement(re, u({}, r2, { colorModel: le }));
};
var Ee = {
	...
	return import_react.createElement(re, u({}, r2, { colorModel: Ee }));
};
var Wrapper = styled.div({
	...
	let presets = (0, import_react.useMemo)(() => (presetColors || []).map((preset) => typeof preset == "string" ? parseValue(preset) : preset.title ? {
...
}, ColorControl = ({ name, value: initialValue, onChange, onFocus, onBlur, presetColors, startOpen = !1, argType }) => {
	let { value, realValue, updateValue, color, colorSpace, cycleColorSpace } = useColorInput(initialValue, (0, import_react.useCallback)(debounce(onChange, 200), [onChange])), { presets, addPreset } = usePresets(presetColors ?? [], color, colorSpace), Picker = ColorPicker[colorSpace], readOnly = !!argType?.table?.readonly, controlId = getControlId(name);
...
//# sourceMappingURL=Color-FRDS63T2-C3gkDElz.js.map